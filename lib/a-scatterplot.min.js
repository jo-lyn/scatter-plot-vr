...
function setupHighlight(el, json, data, particleSystem) {
    ...
    var selectedPoints = {};
    var highlightedPointsMap = {};
    var originalColor = {};


    tick = function(self) {
        if (!self.data.showValueOnHover) return;
        ...
        // Reset color
        highlightedPoints = highlightedPoints.filter(function(i) {
            if (selectedPoints[i]) {
                return true;
            }
            var color = particleSystem.geometry.colors[i];
            color.copy(originalColor[i]);
            highlightedPointsMap[i] = false;
            return false;
        });
        ...
        if (intersects.length > 0) {
            ...
            // Highlight the point
            if (!highlightedPointsMap[highlighted.index]) {
                ...
                highlightedPointsMap[highlighted.index] = true;
            }
    ...
    el.addEventListener("toggle-point", function() {
        if (currentHighlighted !== undefined) {
            selectedPoints[currentHighlighted] = !selectedPoints[currentHighlighted];
        }
    });
}
